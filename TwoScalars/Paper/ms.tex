...
To assign $X$-values to the points, we first do a standard NS run
(or set of runs) that just
uses the first scalar $f_1(\mathbf{x})$. This gives us good estimates of the
$X$-values of the points from this run, which are used as the ``scaffolding''
with which we can infer the $X$-value of any other given point.
